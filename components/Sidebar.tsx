...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView, toggleSidebar, userRole }) => {
  ...
  return (
    <aside className="w-64 flex flex-col h-full bg-white dark:bg-gray-800" aria-label="Sidebar">
      <div className="p-4 px-3 border-b dark:border-gray-700">
      ...
      <div className="p-4 px-3 border-t dark:border-gray-700">
         <ul className="space-y-2">
            <NavItem
              label="Settings"
              icon={<CogIcon />}
